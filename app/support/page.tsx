...
export default function Support() {
      ...
      <div className="px-10">
        ...
        <div className=" border-2 border-[#E4E4E4] mt-10  min-h-[800px] flex">
          ...
          <div className="p-5 flex gap-1 w-full border-b">
                <Avatar>
                  <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" sizes="30" />
  ...
  <div className="border-4 border-[#F1F3F6] w-full p-2"> {/* Set a fixed height for the message bar */}
  <div className="flex items-center relative">
    <label htmlFor="picture">
      <Image src={'/assets/Picture.png'} alt="Picture Icon" width={30} height={30} className=" left-10 top-2 absolute cursor-pointer"/>
    </label>
    <input
      type="file"
      id="picture"
    ...
    function UserMssageList({}) {
      return (<div className="p-5 bg-[#395E66] bg-opacity-10">
              <div className="flex gap-1 w-full ">
                ...
                <p className="bg-[#395E66] rounded-full text-xs w-6 pt-1 h-6 text-center text-white mt-4 ml-5">2</p>
