...
import { formatShortDuration, truncateText } from "@/lib/utils";
      ...
      >
        <div className="flex gap-2 w-full">
          <Avatar className="w-14 h-14">
            <AvatarImage src={`https://storytime-mod-bucket.s3.us-east-2.amazonaws.com/${chat.user.profileImage}`} alt={chat.user.username} />
